...
friend iterator operator+(const const_iterator& it, difference_type diff)
{
    return iterator(it.ptr_ + diff);
}

friend iterator operator+(difference_type diff, const const_iterator& it)
{
    return iterator(it + diff);
}
