...
//Can't figure out why it doesn't worj with unique_ptr

/* void GameMenu::AddGames()
{
    std::unique_ptr<Game> game1(new HangMan("watermelon", "It's a fruit!", 7));
    std::unique_ptr<Game> game2(new TicTacToe("Az", "Ti"));
    games.push_back(game1);
    games.push_back(game2);
} */